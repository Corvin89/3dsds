...
<div id="content-internal">
    ...
    <div id="content-internal-center">
        <div class="contacts">
			<div class="phone"><span class="yellow">Name</span><?php $name=get_post_meta($post->ID,'name'); echo $name[0];?></div>
			<div class="phone"><span class="yellow">Job</span><?php $job=get_post_meta($post->ID,'job'); echo $job[0];?></div>
